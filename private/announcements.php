          ...
          <div id="announcement-list" style="margin-top: 20px;">
            ...
            <?php
                ...
                try{
                    ...
                    echo "<h5>" . $row["created_at"] . "</h5><br>";
                    echo "<h3>" . $row["content"] . "</h3>";
                    if ($_SESSION['role'] == 'admin'){
                      echo "<a href=\"announcements_edit.php?id=" . $row["id"] . "\">編輯</a>";
                      echo "<a href=\"announcements_delete.php?id=" . $row["id"] . "\">刪除</a>";
                    }
                }catch (PDOException $e){
                    header("Location: private/bulletin.php");
                }
            ?>
          </div>
      </div>
